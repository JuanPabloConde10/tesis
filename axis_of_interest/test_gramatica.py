        ...
        for span in aoi.plot_spans:
            ...
            if span.plots_atoms:
                ...
                if num_chars == 1:
                    ...
                    if num_chars == 2:
                        oracion = oracionDosSujetos(
                            aoi.name, span.name, atom_name, "Ana", "Luis"
                        )
                    else:
                        oracion = oracionMultipleSujetos(
                            aoi.name, span.name, atom_name, "Ana", "Luis", "María"
                        )
